...
public:
	...
	void setCustomizationPtr(uintptr_t ptr);
	void setScale(float scale);
	void setNativeMorphID(int id);
...
private:
	...
	// customizations
	std::map<RaceMorphIDs, std::array<uint32_t, 64>> m_customizations;
	std::array<uint32_t, 64> m_native_customizations;
